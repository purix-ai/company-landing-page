        ...
        {mobileMenuOpen && (
          <nav className="md:hidden border-t border-gray-100 py-4" aria-label="Mobile navigation">
            <div className="flex flex-col space-y-3">
              <button
                onClick={() => scrollToSection('features')}
                className="text-gray-700 hover:text-primary-600 transition-colors font-medium text-left px-2 py-2"
              >
                {t('header.features')}
              </button>
              <button
              ...
              <button
                onClick={() => scrollToSection('waitlist')}
                className="px-4 py-2 bg-gradient-to-r from-primary-600 to-secondary-600 text-white rounded-full font-medium text-center mx-2"
